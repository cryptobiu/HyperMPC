 ...
 */
//TFieldElement HIM::Interpolateold (vector<TFieldElement*> alpha, vector<TFieldElement*> x)
//{
//	/**
...
void HIM::MatrixMult3old(std::vector<TFieldElement*> vector, std::vector<TFieldElement*> &answer)
{
